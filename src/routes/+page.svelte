...
{#if !form?.success}
  <main class="flex flex-col items-center justify-center h-[100vh]">
    <div bind:this={bigFont}>
      <h1
        class={`text-primary-500 text-[6em] leading-none text-center font-semibold`}
      >
        Rake
      </h1>
    </div>
    <form method="POST" class="flex flex-col items-center gap-4 ">
      ...
      <input
        class="text-on-primary-token p-4"
        type="password"
        id="password"
        name="password"
        required
      ...
      >
            ...
            >
              ...
              <svelte:fragment slot="content"
                ><span class="text-md font-extralight"
                  >Typically it would take a team of people weeks, if not
        ...
        <div class="rightList w-full md:w-4/12">
          ...
          <Accordion padding="py-6 px-6">
            ...
            >
              <svelte:fragment slot="summary"
                ><span class="text-lg">Instant Deployment</span
                ></svelte:fragment
              >
              <svelte:fragment slot="content"
                ><span class="text-md font-extralight"
